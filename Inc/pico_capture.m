...
potential_num_samples = minimum_num_samples:minimum_num_samples + SAMPLING_FREQUENCY/frequencies(i+1);
evenIndices = rem(potential_num_samples, 2) == 0;
potential_even_num_samples = potential_num_samples(evenIndices);
potential_multiples = potential_even_num_samples*frequencies(i+1)/SAMPLING_FREQUENCY;
...
num_samples = potential_even_num_samples(num_samples_index); 
