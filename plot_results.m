...
out_file = "SPU_LocationBack";
DEVICES = ["SPU03_DPKG_MEMBACK","SPU04_DPKG_MEMBACK_EDGECOVERED", "SPU04_DPKG_MEMBACK_MEMCOVERED"];%, "SPU02_2_DPKG_MEMFRONT"];%, "ADMP01_DPKG_MEMFRONT"];
CUSTOM_FILES = [];
...
NUM_FREQS = 100;
COMBINE_OUTPUTS = ["SPU04_DPKG_MEMBACK_EDGECOVERED", "SPU04_DPKG_MEMBACK_MEMCOVERED"];% ["SPU02_DPKG_MEMFRONT", "SPU02_DPKG_ASICTOP_450nm_5mW_0.33mWpp_1atm"];%["VM02_DPKG_MEMFRONT","VM02_DPKG_ASICTOP"];
COMBINE_COEFFICIENTS = [ones(1,NUM_FREQS); 5*ones(1,NUM_FREQS)];%logspace(log10(10), log10(0.01),NUM_FREQS)];
...
GREEN = [0 0.8 0.2];
BLACK = [0 0 0];
COLOR_ORDER = [BLUE; RED; GREEN];% BLUE];
